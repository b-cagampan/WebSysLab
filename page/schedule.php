            ...
            <div class="card-item">
                <form action="../functions/request_document.php" method="POST">
                    ...
                    <div class="row-radio-btn">
                        <div class="radio-btn">
                            <label>Type of Request Certificate</label>
                            <select name="deliver_method" class="deliver-method">
                                <option value="cert-illness">Certificate of Illness</option>
                                <option value="cert-entry">Certificate of Enter of School</option>
